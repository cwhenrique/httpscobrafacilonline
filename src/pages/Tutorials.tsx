...
import { GraduationCap, Play, Clock, Filter, Settings, VideoOff } from 'lucide-react';
...
const categories = ["Todos", "Início", "Clientes", "Empréstimos", "Pagamentos", "Cobranças", "Relatórios", "Vendas", "Contas"];
