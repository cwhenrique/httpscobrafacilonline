    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="pt-20 pb-8 px-4 relative min-h-[90vh] flex items-center">
        ...
        <div className="container mx-auto text-center relative">
          ...
          >
            <a 
              href="https://wa.me/5511932935877?text=Ol%C3%A1%20gostaria%20de%20saber%20mais%20sobre%20o%20sistema%20CobraF%C3%A1cil%20LP" 
              target="_blank" 
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-background to-card">
        ...
        >
          <div className="bg-card border border-border rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl">
            ...
            <a 
              href="https://wa.me/5511932935877?text=Ol%C3%A1!%20Vim%20do%20site%20do%20CobraF%C3%A1cil%20e%20tenho%20uma%20d%C3%BAvida.%20LP" 
              target="_blank" 
              rel="noopener noreferrer"
      ...
      >
        <div className="container mx-auto flex items-center justify-center gap-3">
          <a 
            href="https://wa.me/5511932935877?text=Ol%C3%A1!%20Vim%20do%20site%20do%20CobraF%C3%A1cil%20e%20gostaria%20de%20tirar%20uma%20d%C3%BAvida.%20LP" 
            target="_blank" 
            rel="noopener noreferrer"
