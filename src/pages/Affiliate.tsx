    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="pt-20 pb-8 px-4 relative min-h-[90vh] flex items-center">
        ...
        <div className="container mx-auto text-center relative">
          ...
          >
            <a 
              href="https://wa.me/5511932935877?text=Ol%C3%A1%20gostaria%20de%20saber%20mais%20sobre%20o%20sistema%20CobraF%C3%A1cil%20AF1"
              target="_blank" 
      ...
      <section className="py-16 px-4 relative">
        ...
        <div className="container mx-auto relative">
          ...
          >
            ...
            <a 
              href="https://wa.me/5511932935877?text=Ol%C3%A1!%20Tenho%20uma%20d%C3%BAvida%20sobre%20o%20CobraF%C3%A1cil.%20AF1" 
              target="_blank" 
              rel="noopener noreferrer"
            >
