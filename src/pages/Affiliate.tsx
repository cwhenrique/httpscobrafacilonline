    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="pt-20 pb-8 px-4 relative min-h-[90vh] flex items-center">
        ...
        <div className="container mx-auto text-center relative">
          ...
          >
            <a 
              href="https://wa.me/5517992147232?text=Olá! Gostaria de testar o CobraFácil por 1 dia gratuitamente. [AF1]" 
              target="_blank" 
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-background to-card">
        ...
        >
          <div className="bg-card border border-border rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl">
            ...
            <a 
              href="https://wa.me/5517992147232?text=Olá! Vim do site do CobraFácil e tenho uma dúvida. [AF1]" 
              target="_blank" 
              rel="noopener noreferrer"
      ...
      >
        <div className="container mx-auto flex items-center justify-center gap-3">
          <a 
            href="https://wa.me/5517992147232?text=Olá! Vim do site do CobraFácil e gostaria de tirar uma dúvida. [AF1]" 
            target="_blank" 
            rel="noopener noreferrer"
