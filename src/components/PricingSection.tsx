              ...
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  ...
                  <div className="text-4xl font-bold text-foreground mb-1">
                    R$ 55<span className="text-2xl">,90</span>
                  </div>
          ...
          >
            <Card className="bg-gradient-to-b from-primary/5 via-card to-primary/5 border-2 border-primary h-full relative overflow-hidden shadow-2xl shadow-primary/30">
              <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-primary via-green-500 to-primary text-primary-foreground text-center py-2 sm:py-3 text-xs sm:text-sm font-bold tracking-wide px-2">
                <span className="hidden sm:inline">🔥 MAIS VENDIDO - MELHOR CUSTO-BENEFÍCIO</span>
              ...
              <CardContent className="p-6 sm:p-8 pt-20 sm:pt-24">
                <div className="text-center mb-6 sm:mb-8">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-primary to-green-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-primary/30">
                    <Calendar className="w-7 h-7 sm:w-8 sm:h-8 text-primary-foreground" />
                  </div>
                  <Badge className="mb-4 bg-primary text-primary-foreground font-bold px-4 py-1">Anual</Badge>
                  <div className="text-4xl sm:text-5xl font-bold text-primary mb-1">
                    R$ 479<span className="text-xl sm:text-2xl">,00</span>
                  </div>
                  <p className="text-sm text-muted-foreground">por ano</p>
                  <p className="text-xs sm:text-sm text-foreground font-medium mt-1">ou 12x de R$ 39,92</p>
                  <div className="mt-3 inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-3 sm:px-4 py-2">
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-primary">Acesso por 12 meses!</span>
                  </div>
                </div>
                <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <li className="flex items-center gap-2 sm:gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" />
                    <span className="text-foreground text-xs sm:text-sm font-medium">Acesso por 12 meses</span>
                  </li>
                  <li className="flex items-center gap-2 sm:gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" />
                  ...
                  <li className="flex items-center gap-2 sm:gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" />
                    <span className="text-foreground text-xs sm:text-sm font-medium">Economia de R$ 191/ano</span>
                  </li>
                </ul>
                <a href={annualLink} target="_blank" rel="noopener noreferrer" className="block">
                  <Button size="lg" className="w-full text-sm sm:text-lg h-12 sm:h-14 bg-gradient-to-r from-primary to-green-600 hover:from-green-600 hover:to-primary shadow-lg shadow-primary/30 font-bold">
                    ...
                    <span className="hidden sm:inline">ASSINAR ANUAL</span>
                    <span className="sm:hidden">ASSINAR ANUAL</span>
                  </Button>
                </a>
            ...
            <Card className="bg-gradient-to-b from-card to-muted/30 border border-primary/50 h-full backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  ...
                  <Badge variant="outline" className="mb-4 border-primary/50 text-primary">Trimestral</Badge>
                  <div className="text-4xl font-bold text-foreground mb-1">
                    R$ 149<span className="text-2xl">,00</span>
                  </div>
                  <p className="text-sm text-muted-foreground">por 3 meses</p>
                  <p className="text-xs sm:text-sm text-foreground font-medium mt-1">ou 3x de R$ 49,67</p>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-muted-foreground text-sm">Acesso por 3 meses</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />
                ...
                <a href={quarterlyLink} target="_blank" rel="noopener noreferrer" className="block">
