...
BEGIN
  ...
  IF loan_record.notes IS NOT NULL THEN
    ...
    -- CORRECAO: NAO somar OVERDUE_CONSOLIDATED separadamente, pois ja representa a mesma multa
  ...
  -- Adicionar APENAS multas ao total (NAO consolidated, pois e a mesma coisa)
